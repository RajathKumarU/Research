...
class Stemmer {
	 ...
	 * 
	 * feed -> feed agreed -> agree disabled -> disable matting -> mat mating ->
	 * mate meeting -> meet milling -> mill messing -> mess meetings -> meet
	 */
	...
	private final void step1() {
		...
		if (ends("eed")) {
			...
			// if (ends("at")) k-=2; else
			/*
			 * if (ends("bl")) setto("ble"); else if (ends("iz")) setto("ize");
			 * else
			 */
			if (doublec(k)) {
				k--;
	 ...
	 * @throws IOException
	 */
	public static void main(File f1, File f2) throws IOException {
		char[] w = new char[501];
